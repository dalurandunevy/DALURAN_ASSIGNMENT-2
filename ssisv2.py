...
#======================================== FRAMES AND LABELS =======================================#
    ...
    headlabel = Label(root, text="", bg="green", fg="white", font=("Arial", 30, "bold"), anchor="center")
    headlabel.place(x=10, y=10, width=1180, height=50)
    
    studentroot = LabelFrame(root, bg='green', text="    STUDENT DETAILS   ", fg="gold", font=("Arial", 20, "bold"))
    courseroot = LabelFrame(root, bg='green',  text="    COURSE DETAILS   ", fg="gold", font=("Arial", 20, "bold"))
    displayroot = LabelFrame(root, bg='green', font=("Arial", 20, "bold"))
...
#======================================== STUDENT LIST FEATURES =======================================#
        ...
        lid = Label(studentroot, text="  ID NUMBER", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        lname = Label(studentroot, text="  NAME", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        lgender = Label(studentroot, text="  GENDER", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        lyear = Label(studentroot, text="  YEAR LEVEL", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        lcourse = Label(studentroot, text="  COURSE", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        addbut = Button(studentroot, text="ADD", command=addStudent, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        updbut = Button(studentroot, text="UPDATE", command=updateStudent, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        delbut = Button(studentroot, text="DELETE", command=deleteStudent, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        clearbut = Button(studentroot, text="CLEAR", command=clear, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        ...
        slabel.config(text="Student ID: ", bg="maroon")
        searchcode.place_forget()
        searchid.place(x=100, y=15, height=30, width=200)
        
        searchbut = Button(displayroot, text="SEARCH", command=searchStudent, relief=FLAT, font=("Arial", 12, "bold"), bg="maroon", fg="white", activeforeground="maroon", activebackground="white")
        searchbut.place(x=305, height=30, y=15, width=80)
        refreshbut = Button(displayroot, text="VIEW ALL", command=lambda: [schidno.set(""), searchStudent()], relief=FLAT, font=("Arial", 12, "bold"), bg="maroon", fg="white", activeforeground="maroon", activebackground="white")
...
#======================================== COURSE LIST FEATURES =======================================#
        ...
        lcourseid = Label(courseroot, text=" COURSE CODE", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ecourseid = Entry(courseroot, textvariable=courseid, font=("Arial", 12, "bold"))
        
        lcoursename = Label(courseroot, text=" COURSE NAME", fg="white", bg="maroon", font=("Arial", 12, "bold"), anchor="w")
        ...
        addbut = Button(courseroot, text="ADD", command=addCourse, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        updbut = Button(courseroot, text="UPDATE", command=updateCourse, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        delbut = Button(courseroot, text="DELETE", command=deleteCourse, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        clearbut = Button(courseroot, text="CLEAR", command=clear, font=("Arial", 14, "bold"), bg="maroon", fg="white", activebackground="gold", activeforeground="black")
        addbut.place(x=25, y=270, width=90, height=35)
        updbut.place(x=125, y=270, width=90, height=35)
        delbut.place(x=225, y=270, width=90, height=35)
        clearbut.place(x=325, y=270, width=90, height=35)
        ...
        slabel.config(text="Course ID: ", bg="maroon")
        searchid.place_forget()
        searchcode.place(x=100, y=15, height=30, width=200)
        
        searchbut = Button(displayroot, text="SEARCH", command=searchCourse, relief=FLAT, font=("Arial", 12, "bold"), bg="maroon", fg="white", activeforeground="maroon", activebackground="gold")
        searchbut.place(x=305, height=30, y=15, width=80)
        refreshbut = Button(displayroot, text="VIEW ALL", command=lambda: [schccode.set(""), searchCourse()], relief=FLAT, font=("Arial", 12, "bold"), bg="maroon", fg="white", activeforeground="maroon", activebackground="gold")
        refreshbut.place(x=390, height=30, y=15, width=80)
...
#========== BUTTONS ==========#
    ...
    studbutton = Button(command=student, text="STUDENTS", fg="gold", bg="maroon", font=("Arial", 18, "bold"), activebackground="white", activeforeground="black")
    coursebutton = Button(command=course, text="COURSES", fg="gold", bg="maroon", font=("Arial", 18, "bold"), activebackground="white", activeforeground="black")
    exitbutton = Button(text="EXIT", command=toexit, fg="gold", bg="maroon", font=("Arial", 18, "bold"), activebackground="white", activeforeground="black")
